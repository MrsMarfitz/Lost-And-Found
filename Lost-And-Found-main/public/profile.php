...
$foto_profil = !empty($user_data['photo_profile']) ? "uploads/" . $user_data['photo_profile'] : "assets/img/user.jpg";
?>
      ...
      <div class="card">
        ...
        <div class="profile-info">
          ...
          <div class="profile-photo-area">
            <img src="<?php echo $foto_profil; ?>" class="profile-photo" alt="Photo Profil">
