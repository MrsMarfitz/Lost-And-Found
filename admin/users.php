...
// Ambil user pertama untuk detail preview
            ...
            <div class="card">
                ...
                <div class="detail-panel" id="detailPanel">
                    <div class="detail-item">
                        ...
                        <span class="detail-value" id="detailNama"><?php echo htmlspecialchars($selected_user['full_name']); ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Username</span>
                        <span class="detail-value" id="detailUsername"><?php echo htmlspecialchars($selected_user['username']); ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Email</span>
                        <span class="detail-value" id="detailEmail"><?php echo htmlspecialchars($selected_user['email']); ?></span>
                    </div>
                    <div class="detail-item">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><span class="tag <?php echo $user['role'] === 'admin' ? 'red' : 'orange'; ?>">
                        ...
                        <td style="text-align:center;">
                            <a href="#" onclick="selectUser(<?php echo htmlspecialchars(json_encode($user)); ?>); return false;" class="action-badge">
                                Detail
                            </a>
                        </td>
                    </tr>
...
<script>
    function selectUser(user) {
        ...
        const roleTag = user.role === 'admin' ? '<span class="tag red">Admin</span>' : '<span class="tag orange">User</span>';
